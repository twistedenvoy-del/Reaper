...
function endIt () {
  finalStand = true;
  gameState = "end";
  showMessage("As you return to the lobby, you see a black mist standing before you. the man was laughing as if he'd just heard the funniest joke ever. he speaks to you 'Finally... I am whole again...!'")
  updateButtons();
  updateDisplay();
}
